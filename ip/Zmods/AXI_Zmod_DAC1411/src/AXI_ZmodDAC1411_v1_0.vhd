...
--    attribute mark_debug of sReg0Rd : signal is "true";
--    attribute keep of sReg0Rd : signal is "true";
--    attribute mark_debug of lReg0Rd : signal is "true";
--    attribute keep of lReg0Rd : signal is "true";
--    attribute mark_debug of lRegRstPulse : signal is "true";
--    attribute keep of lRegRstPulse : signal is "true";
...
--ProcRstOutAddrCntPulse: process (SysClk)  
--begin
--    if (SysClk' event and SysClk = '1') then
--        if (sRst_n = '0') then
--            sOutAddrCntRstR <= '0';
--        else
--            sOutAddrCntRstR <= sOutAddrCntRst;
--        end if;
--    end if;
--end process;

--sOutAddrCntRstPulse <= sOutAddrCntRst and (not sOutAddrCntRstR);
