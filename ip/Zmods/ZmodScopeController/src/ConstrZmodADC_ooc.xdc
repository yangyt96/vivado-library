...
set ZmodDcoClk_period 8.000; # 125MHz max frequency expected for ZmodDcoClk_period
create_clock -period $ZmodDcoClk_period -name ZmodDcoClk -waveform {0.000 4.000} -add [get_ports ZmodDcoClk]